...
var CheckBox = React.createClass({
	...
	handleCheckBoxClick: function (e) {
		if (e.target.checked) {
			...
			var temp = this.state.checkedList;
			if (temp.indexOf(e.target.value) > 0) temp.splice(temp.indexOf(e.target.value), 1);
			this.setState({ checkedList: temp });
		}
	...
	render: function () {
		...
		var checkBox = this.props.checkBoxData.map(function (checkBoxD) {
			return React.createElement(
				'div',
				{ style: styleCheckBox, key: checkBoxD.id },
				React.createElement('input', { type: 'checkbox', value: checkBoxD.value, onClick: that.handleCheckBoxClick }),
				' ',
				checkBoxD.value
			);
		});
...
},{"./CheckBoxItem.jsx":160,"react":158}],160:[function(require,module,exports){
var React = require('react');
...
var CheckBoxItem = React.createClass({
	...
	render: function () {
		...
		return React.createElement(
			'div',
			{ style: divStyle },
			React.createElement('input', { type: 'checkbox', value: this.props.value, onClick: this.handleOnClick }),
			' ',
			this.props.value
		);
	}
...
var selectData = [{ id: 1, value: "India" }, { id: 2, value: "Tibet" }, { id: 3, value: "United States of America" }, { id: 4, value: "United Kingdom" }, { id: 5, value: "Finland" }];

var checkBoxData = [{ id: 1, value: "Certified Plumber" }, { id: 2, value: "Carpentry Experience" }, { id: 3, value: "Certified Electrician" }, { id: 4, value: "Bartending Experience" }, { id: 5, value: "Food Hygiene Certifate" }, { id: 6, value: "First Aid Course" }, { id: 7, value: "Forklift Drive Certifate" }, { id: 8, value: "Driver's Licence(Type B)" }];
...
var JoinUs = React.createClass({
	...
	handleSubmit: function (e) {
		...
		if (!this.state.hasOwnProperty("first_name")) alert("enter first name please");else if (!this.state.hasOwnProperty("last_name")) alert("enter last name please");else if (!this.state.hasOwnProperty("street")) alert("enter street name please");else if (!this.state.hasOwnProperty("city")) alert("enter city name please");else if (!this.state.hasOwnProperty("zip")) alert("enter zip code please");else if (!this.state.hasOwnProperty("email")) alert("enter email please");else if (!this.state.hasOwnProperty("tel")) alert("enter telephone no please");else if (!this.state.hasOwnProperty("gender")) alert("select gender please");else if (!this.state.hasOwnProperty("country")) alert("select country please");else {
	...
	render: function () {
		...
		var selectOptions = selectData.map(function (options) {
			return React.createElement(
				'option',
				{ value: options.value, key: options.id },
				options.value
			);
		});
		...
		return React.createElement(
			...
			React.createElement(
				'div',
				{ className: 'col-md-4', id: 'formBackground' },
				React.createElement(
					'form',
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement('input', { className: 'form-control', id: 'focusedInput1', type: 'text', onChange: this.handleOnChange, placeholder: 'First Name' })
							),
							React.createElement(
								'label',
							...
							React.createElement(
								'select',
								{ id: 'select111', className: 'form-control', onChange: that.handleOnSelect },
								selectOptions
							),
							React.createElement('input', { className: 'form-control', type: 'text', placeholder: 'Street', onChange: this.handleOnChange }),
							React.createElement(
								'div',
								{ className: 'col-md-8' },
								React.createElement('input', { className: 'form-control', type: 'text', placeholder: 'City', onChange: this.handleOnChange })
							),
							React.createElement('div', { className: 'col-md-2' }),
							React.createElement(
								'div',
								{ className: 'col-md-4' },
								React.createElement('input', { className: 'form-control', type: 'text', placeholder: 'Zip', onChange: this.handleOnChange })
							),
							React.createElement('input', { className: 'form-control', type: 'text', placeholder: 'Email', onChange: this.handleOnChange }),
							React.createElement(
								'div',
								{ style: checkBoxStyle },
								React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								'div',
								{ className: 'form-group label-floating' },
								React.createElement('input', { className: 'form-control', id: 'focusedInput1', type: 'text', placeholder: 'Last Name', onChange: this.handleOnChange })
							),
							React.createElement(
								'h4',
								null,
							...
							React.createElement(
								'div',
								{ className: 'col-md-5' },
								React.createElement('input', { type: 'radio', name: 'gender', value: 'Male', onChange: this.handleOnChange }),
								'Male'
							),
							React.createElement('div', { className: 'col-md-2' }),
							React.createElement(
								'div',
								{ className: 'col-md-5' },
								React.createElement('input', { type: 'radio', name: 'gender', value: 'Female', onChange: this.handleOnChange }),
								'Female'
							),
							React.createElement('input', { className: 'form-control', type: 'text', style: telephoneStyle, placeholder: 'Telephone No.', onChange: this.handleOnChange }),
							React.createElement(
								'label',
								{ className: 'control-label' },
								'Comments and other relevent experiences'
							),
							React.createElement('textarea', { className: 'form-control', rows: '6', onChange: this.handleOnChange, id: 'comments' })
						)
					),
					React.createElement(
						'div',
						...
						React.createElement(
							...
							React.createElement(
								'button',
								{ type: 'submit', value: 'Join Us', className: 'btn btn-primary btn-lg', id: 'joinUsButton' },
								'Join Us'
							)
						)
					)
...
},{"./CheckBox.jsx":159,"./SelectCountry.jsx":166,"react":158}],163:[function(require,module,exports){
var React = require('react');
...
var List = React.createClass({
	...
	render: function () {
		...
		var createLink = this.props.items.map(function (menu) {
			return React.createElement(ListItem, { linkContent: menu.text, key: menu.id });
		});
		return React.createElement(
			'ul',
...
var ListItem = React.createClass({
	...
	render: function () {
		return React.createElement(
			...
			React.createElement(
				'a',
				{ className: 'mainMenu', href: '#', onClick: this.redirect },
...
var NavigationBar = React.createClass({
	...
	render: function () {
		...
		return React.createElement(
			'nav',
			{ className: 'navbar navbar-default navbar-fixed-top', id: 'navbar' },
			React.createElement(
				'div',
				...
				React.createElement(
					...
					React.createElement(List, { items: this.props.linkData })
				)
			)
		);
	}
...
},{"./List.jsx":163,"react":158}],166:[function(require,module,exports){
var React = require('react');
...
},{"./CountryOption.jsx":161,"react":158}],167:[function(require,module,exports){
var React = require('react');
...
var data = [{ id: 1, text: "HOME" }, { id: 2, text: "MD#6" }, { id: 3, text: "ABOUT MANUEL" }, { id: 4, text: "HISTORY" }, { id: 5, text: "CONTACT" }];

var slideData = [{ id: 1, divId: "slide-1", divClass: "slide", divCaption: "caption" }, { id: 2, divId: "slide-2", divClass: "slide", divCaption: "caption" }, { id: 3, divId: "slide-3", divClass: "slide", divCaption: "caption" }, { id: 4, divId: "slide-4", divClass: "slide", divCaption: "caption" }];
...
var Main = React.createClass({
	...
	render: function () {
		...
		return React.createElement(
			'div',
			null,
			React.createElement(NavigationBar, { linkData: data })
		);
	}

});

ReactDOM.render(React.createElement(Main, null), document.getElementById('navigationBar'));

ReactDOM.render(React.createElement(JoinUs, null), document.getElementById('joinUs'));

},{"./components/JoinUs.jsx":162,"./components/NavigationBar.jsx":165,"react":158,"react-dom":2}]},{},[167]);
